...
ADD CONSTRAINT PK_Constraint_Name PRIMARY KEY CLUSTERED (Column_Name);
...
CREATE INDEX INDEX_NAME ON [DATABASE_NAME].[SCHEMA].[TABLE_NAME] ([Column_1],[Column_2]) INCLUDE ([Column_3], [Column_4], [Column_5])
